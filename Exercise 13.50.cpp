...
{
    std::cout << "In String copy constructor" << std::endl;
...
{
    std::cout << "In String copy-assignment operator" << std::endl;
...
{
    std::cout << "In String move constructor" << std::endl;
    s.elements = s.first_free = s.cap = nullptr;
}
String& String::operator=(String &&rhs) noexcept
{
    std::cout << "In String move-assignment constructor" << std::endl;
    if (this != &rhs) {
        free();
